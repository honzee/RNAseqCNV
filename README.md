...
Users must have [R](https://www.r-project.org/ target="_blank") and [Rtools](https://cran.r-project.org/bin/windows/Rtools/ target="_blank") installed. [Rstudio](https://rstudio.com/products/rstudio/ target="_blank") is optional but recommended IDE.
